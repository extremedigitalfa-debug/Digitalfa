...
export function buildSeed() {
  ...
  const subscriptions = [
    { id: "sub-1", ownerType: "user", ownerId: "u-cand-1", planId: "ind_pro", status: "active",
  ...
  const sources = [
    // Connettori NON reali (stub/partner): disattivati di default finché non esiste una vera integrazione.
    ...
    // Connettori REALI: Arbeitnow (API pubblica, senza chiave) attivo; Adzuna e Jooble pronti, si attivano appena imposti le chiavi.
    ...
    { id: "src-6", type: "portal", name: "Adzuna Italia", url: "https://api.adzuna.com/v1/api/jobs/it/search/1?what=&results_per_page=50", connector: "http_json",
  ...
  // I candidati demo hanno già un profilo completo → onboarded, con località scelte = città di residenza.
